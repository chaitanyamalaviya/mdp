...
public class MainActivity extends Activity implements SensorEventListener, View.OnTouchListener {
    ...
    public static final int SHOW_ROBOT_MOVE_STATUS = 8;
    public static final int SHOW_OBSTACLE = 9;
    public static final int RESET_GRID = 10;
...
//        createRobotBody(robotcentre[0], robotcentre[1]);
            ...
            updateBtn.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                  // Perform action on click
                    ...
                    // Display Robot
                   /* createRobot(Integer.parseInt(gridMapArr[3]),
                            Integer.parseInt(gridMapArr[4]),
                            Integer.parseInt(gridMapArr[5]),
                            Integer.parseInt(gridMapArr[6])); */

                    //updateSelected = false;
                    //Log.e(TAG, gridMapArr[0]);

                  // Sends request for new gridmap update
                  //sendMessage("");
                }
            });
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            CheckBox pmCB = (CheckBox) findViewById(R.id.motionFnCheckBox);
            //
//            if(D) Log.i(TAG, "handler in~");
//
//            if (msg.what == UPDATE_GRID){
//                if (!autoMode || !updateSelected){
//                    msg.what = -1;
//                }
//            }
...
//                    break;
                ...
                case SHOW_ROBOT_MOVE_STATUS:
                    String readMessage_robot = (String) msg.obj;
                    String displayMessage_robot = "";

                    /* update n display robot movements based on string obtained */
                ...
                case SHOW_OBSTACLE:
                    ...
                    // Displays Obstacle onto the map
                    String obstacleCoords = (String) msg.obj;
                    robotStatus.setText(obstacleCoords);
                ...
                case RESET_GRID:
                    ...
                    // Reset grid map and robot back to start state
                    String robotInfo = (String) msg.obj;
                    robotStatus.setText(robotInfo);
                    updateSelected = false;
